      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-center w-full max-w-7xl mx-auto px-6 md:px-24">
        ...
        >
          ...
          <motion.a
            ...
            className=" abc  text-sm sm:text-lg inline-block mt-4 sm:mt-6 px-6 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-gray-700 to-gray-600 text-white font-medium rounded-md"
        ...
        {/* RIGHT IMAGE */}
        <motion.div
          className="flex justify-center md:justify-end mt-8 md:mt-0 relative group"
